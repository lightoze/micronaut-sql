...
To use Micronaut-based transaction management also add the following dependency:

dependency:micronaut-data-tx[groupId="io.micronaut.data"]

If Spring transaction management is in use, it will instead create the following beans :
